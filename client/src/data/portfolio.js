...
export const aboutHighlights = [
  { icon: '☁️', label: 'Azure & GCP Cloud' },
  { icon: '🤖', label: 'AI & Automation' },
  { icon: '⚡', label: 'Performance First' },
  { icon: '🔐', label: 'Security Focused' },
  { icon: '👥', label: 'Team Mentoring' },
  { icon: '📐', label: 'Clean Architecture' },
]

export const aboutStats = [
  { icon: '🏆', number: '60+', label: 'Recognition Awards' },
  { icon: '🏢', number: '4', label: 'Top Companies' },
  { icon: '🚀', number: '10+', label: 'Enterprise Projects' },
  { icon: '💡', number: '20+', label: 'REST APIs Built' },
]
...
export const skills = [
  ...
  },
  {
    ...
    tags: [
      ...
      { label: 'Vue.js', hot: true },
      { label: 'Redux', hot: true },
      { label: 'Next.js' },
      { label: 'Node.js' },
      { label: 'Webpack' },
      { label: 'Bootstrap' },
  ...
  },
  {
    ...
    tags: [
      ...
      { label: 'GraphQL', hot: true },
      { label: 'Microservices' },
      { label: 'Express.js' },
      { label: 'OSGi / Apache Felix' },
      { label: 'Apache Sling' },
      { label: 'Sling Models' },
      { label: 'J2EE / Servlets' },
    ],
  },
  {
    ...
    name: 'AEM Expertise',
    tags: [
      { label: 'AEM as a Cloud Service', hot: true },
      { label: 'AEM Guides', hot: true },
      { label: 'AEM 6.3 / 6.4 / 6.5', hot: true },
      { label: 'AEM Sites & Assets' },
      { label: 'DAM & Dynamic Media' },
      { label: 'Content Fragments' },
      { label: 'SPA Editor' },
      { label: 'Headless CMS / CaaS' },
      { label: 'Adobe Cloud Manager' },
      { label: 'Workflows & MSM' },
      { label: 'Core Components' },
      { label: 'Adobe Sensei AI' },
    ],
  },
  {
    icon: '☁️',
    ...
    tags: [
      { label: 'Microsoft Azure', hot: true },
      { label: 'GCP' },
      { label: 'Jenkins / CI/CD' },
      { label: 'Azure DevOps' },
      { label: 'Git / Bitbucket' },
  ...
  },
  {
    ...
    tags: [
      { label: 'AI-Assisted Dev (Claude)', hot: true },
      { label: 'GitHub Copilot', hot: true },
      { label: 'LLM / GenAI APIs' },
...
export const experience = [
    ...
    projects: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Refactored Spring Boot application powering 20+ REST APIs post-migration with improved test coverage and reduced startup time.',
          'Replaced legacy SAML middleware with Okta OIDC; integrated React SPA with AEM via the SPA Editor.',
        ],
      },
      {
  ...
  },
  {
    ...
    projects: [
      {
        name: 'Enterprise Intranet Platform',
        bullets: [
          'Owned organization-wide intranet platform enhancements: announcements, leave/holiday management, timesheets, and registrations.',
          'Modernized frontend by migrating large AngularJS modules to React, significantly improving performance and maintainability.',
          'Tuned search relevance and resolved high-priority defects to stabilize the platform across frontend and backend.',
          'Partnered with product, design, and platform teams in an Agile setup, contributing to both UI and Java backend services.',
        ],
      },
    ],
  },
  {
    ...
    role: 'AEM Tech Lead / Full-Stack Developer',
    ...
    projects: [
      {
        ...
        bullets: [
          ...
          'Drove DAM improvements: search facets, metadata schemas, and Adobe Sensei Smart Tags AI integration.',
          'Developed React components for an AEM SPA Editor-based React-in-AEM architecture.',
        ],
      },
      {
    ...
    projects: [
      {
        ...
        bullets: [
          ...
          'Used Vue.js for frontend modules; ensured stable releases via Jenkins CI/CD pipelines.',
        ],
      },
      {
        ...
        bullets: [
          ...
          'Developed Sling Models, Workflows, Core Components, and DAM integrations across multiple brand projects.',
        ],
      },
    ],
  },
...
export const awards = [
  ...
  },
  {
    emoji: '💳',
    company: 'VISA Inc.',
    desc: 'Multiple client appreciations and Spot-on awards for platform contributions.',
  },
  {
    emoji: '⭐',
    company: 'Accenture Solutions',
